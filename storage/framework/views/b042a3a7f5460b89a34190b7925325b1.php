<?php $__env->startSection('content'); ?>
        ...
        <div class="grid place-items-center mx-2 my-20 sm:my-auto" x-data="{ showPass: true, errorMessage: '' }">
            <div class="w-11/12 p-12 sm:w-8/12 md:w-6/12 lg:w-5/12 2xl:w-4/12
                ...
                <form class="space-y-5" id="loginForm">
                    ...
                    <button type="button" class="w-full py-3 mt-10 bg-[#063970] rounded-md
    ...
    <script>
        ...
        document.getElementById('loginForm').addEventListener('submit', function(event) {
            ...
            emailErr.innerHTML = 'loading...';
            login();
        });
    </script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\YouCode\Desktop\Med_el_Bachiri-oauth2-p2\resources\views/pages/auth/login.blade.php ENDPATH**/ ?>