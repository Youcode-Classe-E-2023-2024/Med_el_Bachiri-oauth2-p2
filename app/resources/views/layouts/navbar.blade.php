...
<nav class="bg-white shadow dark:bg-gray-800 flex">
    ...
    <div id="links" class="container flex items-center justify-center p-6 mx-auto text-gray-600 capitalize dark:text-gray-300">
        ...
        .then(data => {
            if (data.success) {
                ...
                if (data.user.roles[0].name === 'SuperAdmin') {
                    links.innerHTML += `
                        <a href="/dashboard" class="border-b-2 border-transparent hover:text-gray-800 dark:hover:text-gray-200 hover:border-blue-500 mx-1.5 sm:mx-6">Dashboard</a>
                    `;
                }
            }
        })
